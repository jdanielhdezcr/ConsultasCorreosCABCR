...
namespace SVCCertificaciones {
    ...
    {
        [OperationContract]
        [WebGet(UriTemplate = "/ConsultarAgremiadoXUsuario/{pUser}", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Bare)]
        agremiado ConsultarAgremiadoXUsuario(string pUser);
