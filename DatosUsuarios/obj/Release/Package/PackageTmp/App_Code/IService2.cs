...
namespace SVCCertificaciones {
    ...
    {
        [OperationContract]
        [WebGet(UriTemplate = "/ConsultarAgremiadoXCedula/{pCedula}", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Bare)]
        agremiado ConsultarAgremiadoXCedula(string pCedula);
