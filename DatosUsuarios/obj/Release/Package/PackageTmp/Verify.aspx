...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="text-align: center">
            ...
            <asp:TextBox ID="txt_codigocer" runat="server" Width="195px"></asp:TextBox>
                ...
                <tr>
                    <td>
            <asp:Button ID="cmd_check" runat="server" Text="Verificar por carné" OnClick="cmd_check_Click" />
                    </td>
                    <td>
                        <asp:Button ID="cmd_cedula" runat="server" Text="Verificar por cédula" OnClick="cmd_cedula_Click" />
                    </td>
                    <td>
                        <asp:Button ID="cmd_username" runat="server" Text="Verificar por usuario de correo" OnClick="cmd_username_Click" />
                    </td>
                    </tr>
                </table>
