...
namespace SVCCertificaciones {
    public class Service : IService //el servicio se conecta con la interface. las funciones declaradas en el contrato se programan acá
    {
    ...
    //public class Service2 : IService2 //el servicio se conecta con la interface. las funciones declaradas en el contrato se programan acá
    //{
    ...
    //            MySqlCommand cmd = new MySqlCommand();
    //            cmd.Connection = con;
    //            cmd.CommandText = "SELECT carnet,user_name FROM users where carnet = '" + rdr2["codigo"].ToString() + "'";
    //            con.Open();
    //            MySqlDataReader rdr = cmd.ExecuteReader();
    //            while (rdr.Read())
    //            {
